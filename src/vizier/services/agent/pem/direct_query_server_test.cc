...
// ===========================================================================
// Routine query shapes — covers the PxL patterns dx pemdirect actually emits.
...
// crash the server or hang the stream. dx-agent's pemdirect doesn't send
// these in production, but defensive coverage means a typo or a bad script
// upgrade can't take direct-query down.
// ===========================================================================
...
// the lifecycle (out of scope for #29 — Stirling startup depends on the
...
// Either approach is a separate, bigger PR than #29. Documented in
