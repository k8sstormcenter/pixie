...
func main() {
	...
	svr, err := controllers.NewServer(env, agentTracker, dataPrivacy, mdtpClient, mdfsClient, mdttClient, mdconfClient, natsConn, controllers.NewQueryExecutorFromServer)
	if err != nil {
