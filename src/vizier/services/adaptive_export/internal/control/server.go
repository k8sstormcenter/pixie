...
// Package control is the dx → AE control surface. It lets the dx-daemon
...
// exporter is the slice of *activeset.ActiveSet this package needs: dx
...
// queryRunner executes one dx-ordered (table, target, window) query and
...
// Server is the dx control HTTP surface.
type Server struct {
	set    exporter
