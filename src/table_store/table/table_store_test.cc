...
class TableStoreTest : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    table1 = HotColdTable::Create("test_table1", rel1);
    table2 = HotColdTable::Create("test_table2", rel2);
  }
...
class TableStoreTabletsTest : public TableStoreTest {
 protected:
  void SetUp() override {
    ...
    tablet1_1 = HotColdTable::Create("test_table1", rel1);
    tablet1_2 = HotColdTable::Create("test_table1", rel1);
    tablet2_1 = HotColdTable::Create("test_table2", rel2);
  }
