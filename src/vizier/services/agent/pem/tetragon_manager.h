...
class TetragonManager : public Manager::MessageHandler {
 public:
  TetragonManager() = delete;
  TetragonManager(px::event::Dispatcher* dispatcher, Info* agent_info,
  ...
  Status HandleRegisterTetragonRequest(const messages::RegisterTetragonRequest& req);
  Status HandleRemoveTetragonRequest(const messages::RemoveTetragonRequest& req);
