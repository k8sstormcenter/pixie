...
type AgentCapabilities struct {
	...
	StoresData   bool `protobuf:"varint,2,opt,name=stores_data,json=storesData,proto3" json:"stores_data,omitempty"`
}
...
func (m *AgentCapabilities) GetStoresData() bool {
	if m != nil {
		return m.StoresData
	}
	return false
...
var fileDescriptor_fef0af3bd5248f34 = []byte{
	...
	,
}
...
func (this *AgentCapabilities) Equal(that interface{}) bool {
	...
	if this.StoresData != that1.StoresData {
		return false
	}
	return true
}
...
func (this *AgentCapabilities) String() string {
	...
	s := strings.Join([]string{`&AgentCapabilities{`,
		...
		`StoresData:` + fmt.Sprintf("%v", this.StoresData) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *AgentCapabilities) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StoresData", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
