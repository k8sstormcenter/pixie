...
type FileSourceInfo struct {
	ID            *uuidpb.UUID             `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	FileSource    *ir.FileSourceDeployment `protobuf:"bytes,2,opt,name=file_source,json=fileSource,proto3" json:"file_source,omitempty"`
	Name          string                   `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
	ExpectedState statuspb.LifeCycleState  `protobuf:"varint,4,opt,name=expected_state,json=expectedState,proto3,enum=px.statuspb.LifeCycleState" json:"expected_state,omitempty"`
}

func (m *FileSourceInfo) Reset()      { *m = FileSourceInfo{} }
func (*FileSourceInfo) ProtoMessage() {}
func (*FileSourceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_27ea71ea705227d1, []int{1}
}
func (m *FileSourceInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FileSourceInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FileSourceInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FileSourceInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileSourceInfo.Merge(m, src)
}
func (m *FileSourceInfo) XXX_Size() int {
	return m.Size()
}
func (m *FileSourceInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_FileSourceInfo.DiscardUnknown(m)
}

var xxx_messageInfo_FileSourceInfo proto.InternalMessageInfo

func (m *FileSourceInfo) GetID() *uuidpb.UUID {
	if m != nil {
		return m.ID
	}
	return nil
...
func (m *FileSourceInfo) GetFileSource() *ir.FileSourceDeployment {
	if m != nil {
		return m.FileSource
	}
	return nil
...
func (m *FileSourceInfo) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *FileSourceInfo) GetExpectedState() statuspb.LifeCycleState {
	if m != nil {
		return m.ExpectedState
	}
	return statuspb.UNKNOWN_STATE
...
type AgentFileSourceStatus struct {
	State   statuspb.LifeCycleState `protobuf:"varint,1,opt,name=state,proto3,enum=px.statuspb.LifeCycleState" json:"state,omitempty"`
	Status  *statuspb.Status        `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
	ID      *uuidpb.UUID            `protobuf:"bytes,3,opt,name=id,proto3" json:"id,omitempty"`
	AgentID *uuidpb.UUID            `protobuf:"bytes,4,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"`
...
func (m *AgentFileSourceStatus) Reset()      { *m = AgentFileSourceStatus{} }
func (*AgentFileSourceStatus) ProtoMessage() {}
func (*AgentFileSourceStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_27ea71ea705227d1, []int{3}
}
func (m *AgentFileSourceStatus) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AgentFileSourceStatus) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AgentFileSourceStatus.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AgentFileSourceStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AgentFileSourceStatus.Merge(m, src)
}
func (m *AgentFileSourceStatus) XXX_Size() int {
	return m.Size()
}
func (m *AgentFileSourceStatus) XXX_DiscardUnknown() {
	xxx_messageInfo_AgentFileSourceStatus.DiscardUnknown(m)
}

var xxx_messageInfo_AgentFileSourceStatus proto.InternalMessageInfo

func (m *AgentFileSourceStatus) GetState() statuspb.LifeCycleState {
	if m != nil {
		return m.State
	}
	return statuspb.UNKNOWN_STATE
...
func (m *AgentFileSourceStatus) GetStatus() *statuspb.Status {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *AgentFileSourceStatus) GetID() *uuidpb.UUID {
	if m != nil {
		return m.ID
	}
	return nil
...
func (m *AgentFileSourceStatus) GetAgentID() *uuidpb.UUID {
	if m != nil {
		return m.AgentID
	}
	return nil
...
type TableInfo struct {
	...
	MutationId       string                  `protobuf:"bytes,8,opt,name=mutation_id,json=mutationId,proto3" json:"mutation_id,omitempty"`
}
...
func (m *TableInfo) GetMutationId() string {
	if m != nil {
		return m.MutationId
	}
	return ""
...
func (*TableInfo_ColumnInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_27ea71ea705227d1, []int{4, 0}
}
...
func (*ComputedSchema_AgentIDs) Descriptor() ([]byte, []int) {
	return fileDescriptor_27ea71ea705227d1, []int{5, 0}
}
...
func (*K8SResourceUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_27ea71ea705227d1, []int{7}
}
...
func (*CronScriptResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_27ea71ea705227d1, []int{8}
}
...
func init() {
	...
	proto.RegisterType((*FileSourceInfo)(nil), "px.vizier.services.metadata.FileSourceInfo")
	proto.RegisterType((*AgentTracepointStatus)(nil), "px.vizier.services.metadata.AgentTracepointStatus")
	proto.RegisterType((*AgentFileSourceStatus)(nil), "px.vizier.services.metadata.AgentFileSourceStatus")
...
var fileDescriptor_27ea71ea705227d1 = []byte{
	...
	,
}
...
func (this *FileSourceInfo) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*FileSourceInfo)
	if !ok {
		that2, ok := that.(FileSourceInfo)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *AgentFileSourceStatus) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*AgentFileSourceStatus)
	if !ok {
		that2, ok := that.(AgentFileSourceStatus)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *FileSourceInfo) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&storepb.FileSourceInfo{")
	if this.ID != nil {
		s = append(s, "ID: "+fmt.Sprintf("%#v", this.ID)+",\n")
	}
	if this.FileSource != nil {
		s = append(s, "FileSource: "+fmt.Sprintf("%#v", this.FileSource)+",\n")
	}
	s = append(s, "Name: "+fmt.Sprintf("%#v", this.Name)+",\n")
	s = append(s, "ExpectedState: "+fmt.Sprintf("%#v", this.ExpectedState)+",\n")
	s = append(s, "}")
...
func (this *AgentFileSourceStatus) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&storepb.AgentFileSourceStatus{")
	s = append(s, "State: "+fmt.Sprintf("%#v", this.State)+",\n")
	if this.Status != nil {
		s = append(s, "Status: "+fmt.Sprintf("%#v", this.Status)+",\n")
	}
...
func (m *FileSourceInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FileSourceInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FileSourceInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AgentFileSourceStatus) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AgentFileSourceStatus) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AgentFileSourceStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TableInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.MutationId) > 0 {
		i -= len(m.MutationId)
		copy(dAtA[i:], m.MutationId)
		i = encodeVarintStore(dAtA, i, uint64(len(m.MutationId)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Desc) > 0 {
...
func (m *FileSourceInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AgentFileSourceStatus) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *FileSourceInfo) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&FileSourceInfo{`,
		`ID:` + strings.Replace(fmt.Sprintf("%v", this.ID), "UUID", "uuidpb.UUID", 1) + `,`,
...
func (this *AgentFileSourceStatus) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AgentFileSourceStatus{`,
		`State:` + fmt.Sprintf("%v", this.State) + `,`,
		`Status:` + strings.Replace(fmt.Sprintf("%v", this.Status), "Status", "statuspb.Status", 1) + `,`,
		`ID:` + strings.Replace(fmt.Sprintf("%v", this.ID), "UUID", "uuidpb.UUID", 1) + `,`,
		`AgentID:` + strings.Replace(fmt.Sprintf("%v", this.AgentID), "UUID", "uuidpb.UUID", 1) + `,`,
...
func (this *TableInfo) String() string {
	...
	s := strings.Join([]string{`&TableInfo{`,
		...
		`MutationId:` + fmt.Sprintf("%v", this.MutationId) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *FileSourceInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FileSourceInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileSourceInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			if m.FileSource == nil {
				m.FileSource = &ir.FileSourceDeployment{}
			}
...
func (m *AgentFileSourceStatus) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AgentFileSourceStatus: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AgentFileSourceStatus: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *TableInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.MutationId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStore(dAtA[iNdEx:])
