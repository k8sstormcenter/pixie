...
func TestOperatorOwnedTables_TrailingOperatorTables(t *testing.T) {
	want := []string{
		...
		"dx_anomaly_orders", "dx_kubescape_anomalies", "dx_src__kubescape_logs", "dx_src__stack_trace", "dx_ord__conn_stats", "dx_ord__redis_events", "dx_ord__http_events", "dx_ord__dns_events", "dx_ord__pgsql_events", "dx_ord__mysql_events", "dx_ord__dc_snoop", "dx_ord__stack_trace", "dx_kubescape_mitre", "dx_src__kubescape_mitre", "dx_orders_win", "dx_dns_resolve", "dx_ord__cql_events", "dx_ord__mongodb_events", "dx_ord__creds_change", "dx_cases", "dx_case_links", "dx_alerts", "dx_breakout_story", "dx_fullchain_edges",
		"dx_shadow_trace",
		"dx_shadow_activity",
		"dx_shadow_dc_snoop",
		"dx_shadow_creds_change",
		"dx_shadow_stack_trace",
		"dx_shadow_conn_stats",
		"dx_shadow_http_events",
		"dx_shadow_http2_messages",
		"dx_shadow_dns_events",
		"dx_shadow_pgsql_events",
		"dx_shadow_redis_events",
		"dx_shadow_mysql_events",
		"dx_shadow_cql_events",
		"dx_shadow_mongodb_events",
		"dx_shadow_kafka_events",
		"dx_shadow_amqp_events",
		"dx_shadow_mux_events",
		"dx_shadow_tls_events",
		"dx_shadow__trace",
		"dx_shadow__activity",
		"dx_shadow__dc_snoop",
		"dx_shadow__creds_change",
		"dx_shadow__stack_trace",
		"dx_shadow__conn_stats",
		"dx_shadow__http_events",
		"dx_shadow__http2_messages",
		"dx_shadow__dns_events",
		"dx_shadow__pgsql_events",
		"dx_shadow__redis_events",
		"dx_shadow__mysql_events",
		"dx_shadow__cql_events",
		"dx_shadow__mongodb_events",
		"dx_shadow__kafka_events",
		"dx_shadow__amqp_events",
		"dx_shadow__mux_events",
		"dx_shadow__tls_events",
		"dx_process_forest",
		"dx_process_forest_events",
		"dx_forest__process",
		"dx_forest__events",
	}
